<template>
    <div>
        ...
        <p class="text-gray-500 mb-4">If you logged into this account via Google, you can skip the current password input.</p>
        ...
        <form @submit.prevent="submit">
            ...
            <label class="input input-bordered flex items-center gap-2">
                ...
                <input v-model="currentPassword" type="password" class="grow placeholder:text-base-content/40"
                    placeholder="Current Password" minlength="8" maxlength="12" />
            </label>
...
const validateForm = () => {
    ...
    canSave.value = passwordLengthValid && passwordsMatch;
};
